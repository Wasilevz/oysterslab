...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-3 text-left align-middle text-xs font-semibold uppercase tracking-wide text-zinc-400",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-3 py-4 align-middle text-zinc-100", className)}
    {...props}
  />
));
