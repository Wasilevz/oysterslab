...
export function AdminDashboard({ onNavigate }: AdminDashboardProps) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      title: t("nav.forgotten"),
      desc: t("shift.forgottenDesc"),
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      key: "shifts" as const,
      title: t("nav.shiftEditor"),
      desc: t("shiftEditor.title"),
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        {myShift && (
          <div className="mt-3 flex items-center justify-between rounded-2xl border border-blue-500/10 dark:bg-blue-500/5 bg-blue-50 px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-blue-400">{t("shift.active")}</span>
            </div>
            <ShiftTimer
